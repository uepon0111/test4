...
function buildDriveProperties(data) {
  ...
  const totalNotes = toInt(
    (data.totalNotes !== undefined && data.totalNotes !== null && data.totalNotes !== '')
      ? data.totalNotes
...
function parseDriveProperties(props) {
  ...
  const totalNotesRaw = props.tn;
  const totalNotes = (totalNotesRaw !== undefined && totalNotesRaw !== '') ? toInt(totalNotesRaw, perfect + great + good + bad + miss) : (perfect + great + good + bad + miss);
  return {
