...
const DEFAULT_REGIONS = {
  difficulty: { x: 0.21, y: 0.05, w: 0.11, h: 0.05 },
  title:      { x: 0.16, y: 0.00, w: 0.28, h: 0.07 },
  level:      { x: 0.27, y: 0.02, w: 0.16, h: 0.06 },
  breakdown:  { x: 0.10, y: 0.35, w: 0.22, h: 0.48 },
  combo:      { x: 0.34, y: 0.20, w: 0.32, h: 0.07 },
};
...
const REGION_DEFS = [
  ...
  { key: 'level',      label: '楽曲Lv.',  color: '#8a63ff' },
